...
public class ControlGUI implements ChangeListener {
	...
	public static void main(String[] args) {
		ControlGUI c = new ControlGUI(new ThresholdsState(), new PitchConstants(0));
	}
	 ...
	 */
	public ControlGUI(ThresholdsState thresholdsState, PitchConstants pitchConstants) {
	...
	private void setUpMainPanel() {
		...
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					FileWriter writer = new FileWriter(new File("pitch" + pitchNum));
	...
	private void setUpBallSliders() {
        ...
        ball_h = setUpSlider(0, 100, pitchConstants.ball_h_low, pitchConstants.ball_h_high, 5,20);
        ...
        ball_s = setUpSlider(0, 100, pitchConstants.ball_s_low, pitchConstants.ball_s_high, 5,20);
        ...
        ball_v = setUpSlider(0, 100, pitchConstants.ball_v_low, pitchConstants.ball_v_high, 5,20);
	...
	private void setUpBlueSliders() {
		...
		blue_h = setUpSlider(0, 100, pitchConstants.blue_h_low, pitchConstants.blue_h_high, 5,20);
		...
		blue_s = setUpSlider(0, 100, pitchConstants.blue_s_low, pitchConstants.blue_s_high, 5,20);
		...
		blue_v = setUpSlider(0, 100, pitchConstants.blue_v_low, pitchConstants.blue_v_high, 5,20);
	...
	private void setUpYellowSliders() {
		...
		yellow_h = setUpSlider(0, 100, pitchConstants.yellow_h_low, pitchConstants.yellow_h_high, 5,20);
		...
		yellow_s = setUpSlider(0, 100, pitchConstants.yellow_s_low, pitchConstants.yellow_s_high, 5,20);
		...
		yellow_v = setUpSlider(0, 100, pitchConstants.yellow_v_low, pitchConstants.yellow_v_high, 5,20);
	...
	private void setUpGreySliders() {
		...
		grey_h = setUpSlider(0, 100, pitchConstants.grey_h_low, pitchConstants.grey_h_high, 5,20);
		...
		grey_s = setUpSlider(0, 100, pitchConstants.grey_s_low, pitchConstants.grey_s_high, 5,20);
		...
		grey_v = setUpSlider(0, 100, pitchConstants.grey_v_low, pitchConstants.grey_v_high, 5,20);
	...
	private void setUpGreenSliders() {
		...
		green_h = setUpSlider(0, 100, pitchConstants.green_h_low, pitchConstants.green_h_high, 5,20);
		...
		green_s = setUpSlider(0, 100, pitchConstants.green_s_low, pitchConstants.green_s_high, 5,20);
		...
		green_v = setUpSlider(0, 100, pitchConstants.green_v_low, pitchConstants.green_v_high, 5,20);
