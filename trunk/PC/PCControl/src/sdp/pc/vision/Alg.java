 ...
 * state, video feed, data, etc. (Don't instantiate an Alg)
 * 
 */
public class Alg {
	...
	/**
	 * Given any set of points, returns a linked list containing the edges of
	 * the smallest convex polygon that can be fit around the given set of
	 * points.
	 * 
	 * @param pts
	 * @return a LinkedList of Point2's, containing the edges of the surrounding
	 *         polygon
	 */
